...
function downloadFile(filePath, fileName) {
    ...
    if (correctedPath.startsWith('http://') || correctedPath.startsWith('https://')) {
        ...
        // Convert to relative path from manager folder
        correctedPath = '../' + correctedPath;
    } else if (correctedPath.startsWith('../uploads/')) {
        // Already correct for manager folder
        // Keep as is
    } else if (correctedPath.startsWith('../../uploads/')) {
...
function viewImage(imagePath, imageName) {
    // Fix image path for manager panel
    let correctedPath = imagePath;

    // Ensure path is correct for manager folder
    // Database stores: uploads/job_pictures/...
    // API returns: ../uploads/job_pictures/...
    // For manager/view-job.php, we need: ../uploads/job_pictures/...
